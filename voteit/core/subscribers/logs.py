## Should be reworked to use pythons standard logging system if needed
...
# #@subscriber([IVote, IObjectAddedEvent]) #FIXME: Make sure it doesn't cause concurrency errors!
