...
@schema_factory('LayoutSchema', title=_(u"Layout"), description=_(u"change_layout", default = u"Change layout of the different parts in the meeting (advanced feature)"))
