...
.. glossary::
  ...
  deform
    ...
    Form generation library. Handles all forms within VoteIT.
  ...
  mr.developer
    ...
    Extension for :term:`buildout` that handles development of various packages. A must!
    See `<https://pypi.python.org/pypi/mr.developer>`_.
  ...
  pip
    ...
    An installer for Python packages. See `<https://pip.readthedocs.org>`_.
  ...
  Virtualenv
    ...
    Utility to create an isolated Python environment. See `<http://www.virtualenv.org>`_

  Waitress

    A :term:`WSGI`-server. See `<https://pylons.readthedocs.org/projects/waitress>`_.

  WSGI

    Web Server Gateway Interface. Standard for Python. See `<http://en.wikipedia.org/wiki/Web_Server_Gateway_Interface>`_.
